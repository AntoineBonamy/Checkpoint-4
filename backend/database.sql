...
INSERT INTO `checkpoint4`.`spaceship`(name, description, lightspeed, state, skin) VALUES("TARDIS", "C'est plus grand à l'intérieur.", 1, "Parfait état", "https://www.slsc.org/wp-content/uploads/2023/02/tardis-doctor-who.jpg");
